  ...
  return (
    <div className="min-h-screen">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-5 py-6">
        <NestLogo />
        <Link to="/app" className="inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-sm font-semibold text-background transition hover:opacity-90">
      ...
      <section className="mx-auto max-w-6xl px-5 pt-8 pb-20 text-center">
        ...
        <h1 className="mx-auto mt-5 max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl md:text-7xl animate-float-in">
          Shared living,<br />
          <span className="bg-gradient-to-r from-brand to-orange-500 bg-clip-text text-transparent">effortlessly settled.</span>
        </h1>
        ...
        <div className="mt-8 flex justify-center gap-3 animate-float-in">
          <Link to="/app" className="inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3.5 text-sm font-semibold text-white shadow-brand transition hover:scale-[1.02]">
            Get started <ArrowRight className="h-4 w-4" />
          </Link>
          <a href="#features" className="inline-flex items-center gap-2 rounded-full bg-card px-6 py-3.5 text-sm font-semibold ring-1 ring-border transition hover:bg-muted">
            See how it works
          </a>
        </div>
